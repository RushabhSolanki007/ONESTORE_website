       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/ONE STORE.png" alt="ONE STORE Logo" class="hidden-xs" height="35" width="130">
                   <img src="images/ecom-store-logo-mobile.png" alt="ONE STORE Logo Mobile" class="visible-xs" height="40" width="120">
