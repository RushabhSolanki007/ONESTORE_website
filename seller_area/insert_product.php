<?php 
    ...
    if(!isset($_SESSION['seller_email'])){
        ...
        $get_seller = "select * from sellers where seller_email='$s_email'";
...
if(isset($_POST['submit'])){
    ...
    $insert_product = "insert into products (s_id,p_cat_id,cat_id,manufacturer_id,date,product_title,product_url,product_img1,product_img2,product_img3,product_price,product_quantity,product_keywords,product_desc,product_features,product_video,product_label,product_sale) values ('$s_id','$product_cat','$cat','$manufacturer_id',NOW(),'$product_title','$product_url','$product_img1','$product_img2','$product_img3','$product_price','$product_quantity','$product_keywords','$product_desc','$product_features','$product_video','$product_label','$product_sale')";
