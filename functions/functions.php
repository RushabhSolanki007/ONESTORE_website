        ...
        <div class='col-md-4 col-sm-6 single'>
            ...
            <div class='product'>
                ...
                <center>
                    ...
                    <p class='quantity-2'> ".($pro_quantity == 0 ?  "out of stock" : "")." </p>
...
function getSearch($user_search){

    $search_value = trim($user_search);
    ...
    while($row_products=mysqli_fetch_array($run_products)){
        ...
        $run_s_pro = mysqli_query($db,$get_s_pro);
        ...
        while($row_s_pro = mysqli_fetch_array($run_s_pro))
        {
            ...
            $pro_sale_price = $row_s_pro['product_sale'];

            $pro_url = $row_s_pro['product_url'];
            
            $pro_img1 = $row_s_pro['product_img1'];

            $pro_quantity = $row_s_pro['product_quantity'];
            
            $pro_label = $row_s_pro['product_label'];
            
            $manufacturer_id = $row_s_pro['manufacturer_id'];
